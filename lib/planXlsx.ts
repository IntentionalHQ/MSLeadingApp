...
function readmeRows(planDate: string): string[][] {
  const L: string[] = [
    ...
    "The leader is the teacher. An assistant is only an editor and organizer. The finished lesson should contain the leader's substance with the assistant's word structure, not the assistant's substance written to sound like the leader.",
    "",
    ...
    "  4. Organize the leader's supplied devotional thoughts into Notes and Script.",
    "  5. Build the Discussion questions from the passage and the leader's approved points.",
    ...
    "",
    "THE LEADER IS THE TEACHER. The leader decides what the students hear. An assistant is only an editor and organizer and does not determine theology, meaning, application, or spiritual direction.",
    "What an assistant MAY add: organization, grammar, transitions, pacing, clarity, simpler wording for middle school, verse markers, headings, and condensing the approved devotional into Notes. An assistant may verify a Scripture reference the leader already introduced.",
    "What an assistant MAY NOT add on its own: teaching points, interpretations, applications, analogies, illustrations, Scripture connections, spiritual conclusions, challenges to students, or memorable closing lines.",
    "Do not finish incomplete theology. If the leader has not supplied the meaning, application, analogy, or conclusion, ask or flag the gap. Do not fill it in.",
    "Suggestions: any teaching idea the assistant creates must be labeled 'PROPOSED - NOT FOR THE OUTLINE'. It cannot enter the workbook unless the leader explicitly adopts it.",
    "Traceability: every major teaching point, application, analogy, Scripture connection, and conclusion in the devotional must trace back to something the leader said or explicitly approved.",
    "'Write this in my voice' means rewrite the leader's substance in natural spoken wording. It does not mean invent new sermon content in the leader's style.",
    "Factual correction: if something seems biblically, historically, or factually questionable, flag it briefly and explain why. Do not silently replace it with the assistant's own teaching. Then follow the leader's final decision unless doing so would require fabricating Scripture.",
    "When there is more than one reasonable reading, lay out the options and ask which the leader wants to teach rather than picking one. Do not push a denominational, political, or personal position. Nothing goes into the file until the leader has seen it and said yes.",
    "",
    ...
    "  • Notes = what the leader glances at while teaching. Short, scannable, mostly bullets, broken up by passage section with verse markers like V21-23, V24-25, V26-29. Detailed enough to remind the leader what point comes next, never full paragraphs. Notes only summarize the approved devotional; no teaching may appear in Notes that is not already in the approved Script. The leader should be able to glance down, find their place, and keep talking naturally. The app shows Notes at the top of the leading screen for this section.",
    "  • Script = the complete devotional written in the leader's natural speaking voice. Conversational, not academic. Simple language for middle-school students. Preserve the leader's illustrations and phrasing. Include verse markers such as (V21-23) throughout so students can follow in their Bibles. Turn the leader's approved Say / Mean / Do thoughts into clear read-aloud wording. Do not independently determine the meaning or application. Include a Scripture connection only if the leader introduced it. Written as flowing PARAGRAPHS, the way a person talks, not as a script. No speaker labels, no 'Leader:' lines, no stage directions, no bullet points, no numbered steps, no headings, no bold. Just short paragraphs the leader reads straight through, with the (V21-23) markers inline. The Script can be longer than the Notes.",
    "",
    "DISCUSSION SECTION",
    ...
    "Before returning, check: 1) passage is correct  2) full passage text is in Bible Reading Script  3) Devotional Notes match the approved devotional  4) Devotional Script is plain paragraphs with inline verse markers, no speaker labels or bullets  5) Discussion instructions begin with 'What stood out to you in that?'  6) Say / Mean / Do questions are backups, not the main method  7) recurring sections preserved  8) no unapproved teaching content, and every teaching point, application, analogy, and conclusion traces to something the leader said or approved  9) timing totals correctly  10) structure and sheet names preserved. Then list what changed from the current draft and confirm each item was approved.",
    "",
...
export async function buildTemplate(it: Itinerary, sections: Section[], past: PastOutline[]): Promise<ArrayBuffer> {
  ...
  const typeHelp: Record<SectionType, string> = {
    ...
    devotional: "The leader teaches. Notes = glance-down bullets with verse markers; Script = the full read-aloud version in plain paragraphs (not script format).",
